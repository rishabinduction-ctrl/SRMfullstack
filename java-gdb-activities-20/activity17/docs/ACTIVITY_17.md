...
## Prerequisites
- Activity 16 completed: `Transaction` model and `TransactionType` enum.
- Understanding of the **Command Design Pattern**, **Java Object Serialization** (`Serializable`, `ObjectOutputStream`, `ObjectInputStream`), and File I/O.
