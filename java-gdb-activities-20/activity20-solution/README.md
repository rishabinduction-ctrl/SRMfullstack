# Activity 20: AccountUI (Interactive Console Application) (Solution)

## Solution Overview
This solution provides a complete menu-driven console application (`AccountUI`) encapsulating the banking service workflows and user interactions.
